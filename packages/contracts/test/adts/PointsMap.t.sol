...
import { Faction } from "codegen/index.sol";
...
contract PointsMapTest is PrimodiumTest {
  ...
  function testIncreaseScore() public {
    ...
    assertEq(Faction.getPointsIssued(EEmpire.Red), 50);
  }
  ...
  function testRemove() public {
    ...
    assertEq(Faction.getPointsIssued(EEmpire.Red), 0);
  }
