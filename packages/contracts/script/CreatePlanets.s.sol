...
function createPlanets() {
  ...
  Planet.set(
    redPlanetId,
    PlanetData({ q: 1, r: -2, isPlanet: true, destroyerCount: 0, factionId: EEmpire.Red, goldCount: 0 })
  );
  ...
  Planet.set(
    bluePlanetId,
    PlanetData({ q: -2, r: 1, isPlanet: true, destroyerCount: 0, factionId: EEmpire.Blue, goldCount: 0 })
  );
  ...
  Planet.set(
    greenPlanetId,
    PlanetData({ q: 1, r: 1, isPlanet: true, destroyerCount: 0, factionId: EEmpire.Green, goldCount: 0 })
  );
  ...
  Planet.set(
    planet4,
    PlanetData({ q: 0, r: -1, isPlanet: true, destroyerCount: 0, factionId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet5,
    PlanetData({ q: 1, r: -1, isPlanet: true, destroyerCount: 0, factionId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet6,
    PlanetData({ q: -1, r: 0, isPlanet: true, destroyerCount: 0, factionId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet7,
    PlanetData({ q: 0, r: 0, isPlanet: true, destroyerCount: 0, factionId: EEmpire.NULL, goldCount: 0 })
  );
