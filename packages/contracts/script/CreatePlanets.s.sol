...
function createPlanets() {
  ...
  Faction.set(EEmpire.Red, EOrigin.North, 0, 0, new uint256[](EAction.LENGTH));
  ...
  Faction.set(EEmpire.Blue, EOrigin.Southwest, 0, 0, new uint256[](EAction.LENGTH));
  ...
  Faction.set(EEmpire.Green, EOrigin.Southeast, 0, 0, new uint256[](EAction.LENGTH));
