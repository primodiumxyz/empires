...
library EmpirePlanetsSet {
  ...
  function add(EEmpire empireId, bytes32 planetId) internal {
  ...
  function getEmpirePlanetIds(EEmpire empireId) internal view returns (bytes32[] memory asteroidEntities) {
