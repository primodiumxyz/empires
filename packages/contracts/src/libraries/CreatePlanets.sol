...
function createPlanets() {
  ...
  Planet.set(
    redPlanetId,
    PlanetData({ q: 101, r: -2, isPlanet: true, shipCount: 0, shieldCount: 0, empireId: EEmpire.Red, goldCount: 0 })
  );
  ...
  Planet.set(
    bluePlanetId,
    PlanetData({ q: 98, r: 1, isPlanet: true, shipCount: 0, shieldCount: 0, empireId: EEmpire.Blue, goldCount: 0 })
  );
  ...
  Planet.set(
    greenPlanetId,
    PlanetData({ q: 101, r: 1, isPlanet: true, shipCount: 0, shieldCount: 0, empireId: EEmpire.Green, goldCount: 0 })
  );
  ...
  Planet.set(
    planet4,
    PlanetData({ q: 100, r: -1, isPlanet: true, shipCount: 0, shieldCount: 4, empireId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet6,
    PlanetData({ q: 99, r: 0, isPlanet: true, shipCount: 0, shieldCount: 4, empireId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet7,
    PlanetData({ q: 100, r: 0, isPlanet: true, shipCount: 0, shieldCount: 4, empireId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet8,
    PlanetData({ q: 101, r: 0, isPlanet: true, shipCount: 0, shieldCount: 4, empireId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet9,
    PlanetData({ q: 99, r: 1, isPlanet: true, shipCount: 0, shieldCount: 4, empireId: EEmpire.NULL, goldCount: 0 })
  );
  ...
  Planet.set(
    planet10,
    PlanetData({ q: 101, r: -1, isPlanet: true, shipCount: 0, shieldCount: 4, empireId: EEmpire.NULL, goldCount: 0 })
  );
