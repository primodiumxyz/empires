  ...
  World: {
    ...
    tables: {
      ...
      P_PointConfig: {
        ...
        startPointCost: BigInt(POINTS_UNIT * 0.00001),
  ...
  CreateShipOverride: {
    ...
    tables: {
      P_OverrideConfig: {
        ...
        overrideGenRate: BigInt(POINTS_UNIT * 0.000020),
        overrideCostIncrease: BigInt(POINTS_UNIT * 0.000005),
      },
    },
  },
  ...
  KillShipOverride: {
    ...
    tables: {
      P_OverrideConfig: {
        ...
        overrideCostIncrease: BigInt(POINTS_UNIT * 0.000010),
      },
    },
  },
  ...
  ChargeShieldOverride: {
    ...
    tables: {
      P_OverrideConfig: {
        ...
        overrideGenRate: BigInt(POINTS_UNIT * 0.000010),
  ...
  DrainShieldOverride: {
    ...
    tables: {
      P_OverrideConfig: {
        isProgressOverride: false,
        minOverrideCost: 0n,
        startOverrideCost: BigInt(POINTS_UNIT * 0.000400),
        overrideGenRate: BigInt(POINTS_UNIT * 0.000010),
        overrideCostIncrease: BigInt(POINTS_UNIT * 0.000004),
      },
    },
  },
