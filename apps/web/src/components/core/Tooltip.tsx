        ...
        <AnimatePresence>
          <motion.div
            ...
            className={cn(
              ...
              "pixel-border absolute z-50 flex w-fit flex-col items-center justify-center bg-neutral p-3 text-center text-xs shadow-xl heropattern-graphpaper-slate-800/50",
              className,
            )}
          >
            {tooltipContent}
