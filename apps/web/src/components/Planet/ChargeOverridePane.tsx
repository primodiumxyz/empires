    ...
    <div className="flex w-full flex-col items-center gap-4">
      ...
      <div className="flex gap-2">
        <div className="flex flex-col items-center">
          ...
          <p className="rounded-box rounded-t-none bg-secondary/25 p-1 text-center text-xs opacity-75">{stunPrice}</p>
        </div>
        <div className="gap1 flex flex-col items-center">
          ...
          <p className="rounded-box rounded-t-none bg-error/25 p-1 text-center text-xs opacity-75">{boostPrice}</p>
        </div>
      </div>
    </div>
  );
